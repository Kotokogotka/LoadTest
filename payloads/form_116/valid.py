...
from payloads.form_116.dictionaries import (
...
def build_form_116_payload():
    ...
    return {
        ...
        "data": [
            ...
            {
                "field_id": 15615,
                "value": f"{birth_year}-{random.randint(1, 12):02d}-{random.randint(1, 28):02d}",
                "entity": "",
                "comments": "",
            },
            {
                "field_id": 15645,
                "value": f"{random.choice(['ABC', 'DEF'])}{birth_year}",
                "entity": "",
                "comments": "",
            },
            ...
            {
                "field_id": 15669,
                "value": [previous_illness_item["name"]],
                "entity": [previous_illness_item["id"]],
                "comments": "",
            },
            {"field_id": 15696, "value": [yes_no_item["name"]], "entity": [yes_no_item["id"]], "comments": ""},
            {
                "field_id": 15686,
                "value": [observation_item["name"]],
                "entity": [observation_item["id"]],
                "comments": "",
            },
            ...
            {"field_id": 15641, "value": random_date if yes_no_item["id"] == "282" else "", "entity": "", "comments": ""},
            {"field_id": 30385, "value": random_date if yes_no_item["id"] == "282" else "", "entity": "", "comments": ""},
            {"field_id": 15643, "value": [yes_no_item["name"]], "entity": [yes_no_item["id"]], "comments": ""},
            {"field_id": 15644, "value": random_date if yes_no_item["id"] == "282" else "", "entity": "", "comments": ""},
            {
                "field_id": 15668,
                "value": [emergency_item["name"]],
                "entity": [emergency_item["id"]],
                "comments": "",
            },
            ...
            {"field_id": 30376, "value": random_date if yes_no_item["id"] == "282" else "", "entity": "", "comments": ""},
            ...
            {"field_id": 30366, "value": random_date if yes_no_item["id"] == "282" else "", "entity": "", "comments": ""},
            ...
            {"field_id": 30405, "value": random_date if yes_no_item["id"] == "282" else "", "entity": "", "comments": ""},
